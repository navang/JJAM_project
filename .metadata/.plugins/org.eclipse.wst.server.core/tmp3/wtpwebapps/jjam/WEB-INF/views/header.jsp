         ...
         <div class="container">
             ...
             <div id="myNav" class="collapse navbar-collapse justify-content-end">
                 <ul class="navbar-nav">
                     ...
                     <li class="nav-item"><a href="jjam_3_form.do" class="nav-link">나눔찾기(메인지도)</a></li>
                     <li class="nav-item"><a href="jjam_2_search.do" class="nav-link">검색하기</a></li>
                     <li class="nav-item"><a href="jjam_6_mypage.do" class="nav-link">마이페이지</a></li>
                     <li class="nav-item"><a href="jjam_login&out.do" class="nav-link">로그인/로그아웃</a>
