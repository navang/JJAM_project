                    ...
                    <div class="modal-content modal-size">
                        ...
                        <div class="modal-body ">
                            <div class="modal-inner-grid">
                                <div>
                                    <div>
                                            <li>${data.c_id} 님의 나눔</li>
                                            <li>제목 &nbsp; : ${data.b_title}</li>
                                            <li>품목 &nbsp; : ${data.b_no}</li>
                                            <li>위치 &nbsp; : ${data.b_location}</li>
                                            <li>가격 &nbsp; : ${data.b_price}</li>
                                            <li>날짜 &nbsp; : ${data.b_date}</li>
                                             <li>내용 &nbsp; : ${data.b_content}</li>
                                ...
                                <div><img src="<%=data.getCate_icon()%>.png" class="w-100 h-100" alt=""></div>
                            </div>
