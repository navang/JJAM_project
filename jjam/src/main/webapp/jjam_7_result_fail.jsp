...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="stylesheet" href="./resources/style/fail.css">
...
<script>
  $(function(){
	  ...
	  // 연결이 실패하였습니다 ^^ 
	  $('.result-form-item span').hover(function(){
		...
		if($(this).hasClass('active')) 
			$(this).css({
		 	...
		 	$(this).click(function(){
		 		$(this).removeAttr('style').delay(3000);
		 	});
	  });
  });
...
<div class="result-form-item-line"></div>
<div>
<input type="button" class="result-button" />
</div>
